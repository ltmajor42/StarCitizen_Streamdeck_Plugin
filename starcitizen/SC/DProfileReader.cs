...
public class DProfileReader
{
    ...
    /// <summary>
    /// Represents an activation mode configuration for an action.
    /// </summary>
    ...
    /// <summary>
    /// Represents a single action binding with keyboard, mouse, joystick, and gamepad mappings.
    /// </summary>
    public class Action
    {
    ...
    /// <summary>
    /// Gets a binding by its full function name.
    /// </summary>
    /// <param name="key">The function name (e.g., "spaceship_flight-v_pitch").</param>
    ...
    /// <summary>
    /// Gets all actions including unbound ones.
    /// </summary>
    /// <returns>Dictionary of all actions keyed by function name.</returns>
    public Dictionary<string, Action> GetAllActions() =>
        maps.SelectMany(x => x.Value.Actions.Values).ToDictionary(x => x.Name, x => x);

    /// <summary>
    /// Gets actions without any input bindings.
    /// </summary>
    /// <returns>Dictionary of unbound actions.</returns>
    ...
    /// </summary>
    /// <param name="enableCsvExport">If true, exports CSV files.</param>
