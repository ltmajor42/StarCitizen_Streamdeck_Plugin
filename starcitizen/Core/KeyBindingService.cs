...
/// <list type="bullet">
/// <item><description>Loads bindings from defaultProfile.xml (base layer from Data.p4k)</description></item>
/// <item><description>Applies actionmaps.xml overrides (user customizations)</description></item>
/// <item><description>Watches for actionmaps.xml changes and triggers reload</description></item>
/// <item><description>Raises KeyBindingsLoaded event when bindings are refreshed</description></item>
/// </list>
/// </remarks>
public sealed class KeyBindingService : IDisposable
{
    ...
    /// </summary>
    public static KeyBindingService Instance { get; } = new();
    ...
    /// <summary>
    /// Raised when key bindings are loaded or reloaded.
    /// </summary>
    public event EventHandler KeyBindingsLoaded;

    /// <summary>
    /// Gets the current binding reader. May be null if not yet initialized.
    /// </summary>
    public DProfileReader Reader { get; private set; }

    /// <summary>
    /// Gets the bindings version. Incremented each time bindings are successfully loaded.
    ...
    /// <summary>
    /// Queues a reload of bindings on a background thread.
    /// </summary>
